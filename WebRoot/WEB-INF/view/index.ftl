			...
			<div class="focus-box" style="overflow: hidden;">
				<ul id="JS-recommend_ul" class="focus-con clearfix"
					style="width: 980px;">
						...
						<div class="list-item">
							<a class="item-figure"
								href="/deal-show/id-2632" target="_blank">
								<img src="images/tt.jpg" alt="那世界，没你不行——“那世界”世界巡回演唱会 • 郑州站">
							</a>
							<div class="item-upvote">
								<a class="icons " href="javascript:void(0);" rel="150"
									onclick="like_deal_v2(2632, this)">150</a>
							</div>
							<h3>
								<a href="/deal-show/id-2632"
									target="_blank">那世界，没你不行——“那世界”世界巡回演唱会 • 郑州站</a>
							</h3>
							<div class="item-caption">
								<span class="btn-base btn-red-h20 common-sprite"> <span
									class="common-sprite">已认证</span>
							...
							<div class="item-rate clearfix">
								<span class="rate1"> <em>5%</em><br>好评度
								</span> <span class="rate3"> <em>5</em><br>资历指数
								</span>
							</div>
						</div>
					</li>
					<li>
						...
						<div class="list-item">
							<a class="item-figure"
								href="/deal-show/id-1782" target="_blank">
								<img src="images/tt.jpg" alt="“我想摸摸月球车”众筹网独家爱心众筹活动">
							</a>
							<div class="item-upvote">
								<a class="icons " href="javascript:void(0);" rel="478"
									onclick="like_deal_v2(1782, this)">478</a>
							</div>
							<h3>
								<a href="/deal-show/id-1782"
									target="_blank">“我想摸摸月球车”众筹网独家爱心众筹活动</a>
							</h3>
							<div class="item-caption">
								<span class="btn-base btn-red-h20 common-sprite"> <span
									class="common-sprite">已认证</span>
							...
							<div class="progress-bar">
								<span class="progress bg-red" style="width: 113%;"></span>
							</div>
							<div class="item-rate clearfix">
								<span class="rate1"> <em>113%</em><br>好评度
								</span> <span class="rate3"> <em>56</em><br>资历指数
								</span>
							</div>
						</div>
					</li>
			...
			<div class="hot-project">
				<ul class="clearfix">
					...
					<li>
						...
						<div class="list-item">
							<a class="item-figure"
								href="/deal-show/id-2385" target="_blank">
								<img src="images/tt.jpg" alt="父亲的水稻田：挽留最后的农耕">
							</a>
							<div class="item-upvote">
								<a class="icons " href="javascript:void(0);" rel="122"
									onclick="like_deal_v2(2385, this)">122</a>
							</div>
							<h3>
								<a href="/deal-show/id-2385"
									target="_blank">父亲的水稻田：挽留最后的农耕</a>
							</h3>
							<div class="item-caption">
								<span class="caption-title">目标：<em>60天</em> <em><i
										class="font-yen">¥</i>20000</em></span> <span
									class="btn-base btn-red-h20 common-sprite"> <span
									class="common-sprite">众筹中</span>
								</span>
							</div>
							<div class="progress-bar">
								<span class="progress bg-red" style="width: 38%;"></span>
							</div>
							<div class="item-rate clearfix">
								<span class="rate1"> <em>38%</em><br>好评度
								</span> <span class="rate2"> <em><a>报名</a></em><br>
								</span> <span class="rate3"> <em>38天</em><br>剩余时间
								</span>
							</div>
						</div>
					</li>
					<li>
						...
						<div class="list-item">
							<a class="item-figure"
								href="/deal-show/id-2589" target="_blank">
								<img src="images/tt.jpg" alt="“画廊去哪了”——798艺术区画廊生存现状调查">
							</a>
							<div class="item-upvote">
								<a class="icons " href="javascript:void(0);" rel="48"
									onclick="like_deal_v2(2589, this)">48</a>
							</div>
							<h3>
								<a href="/deal-show/id-2589"
									target="_blank">“画廊去哪了”——798艺术区画廊生存现状调查</a>
							</h3>
							<div class="item-caption">
								<span class="caption-title">目标：<em>20天</em> <em><i
										class="font-yen">¥</i>2000</em></span> <span
									class="btn-base btn-red-h20 common-sprite"> <span
									class="common-sprite">众筹中</span>
								</span>
							</div>
							<div class="progress-bar">
								<span class="progress bg-red" style="width: 63%;"></span>
							</div>
							<div class="item-rate clearfix">
								<span class="rate1"> <em>63%</em><br>好评度
								</span> <span class="rate2"> <em><a>报名</a></em><br>
								</span> <span class="rate3"> <em>7天</em><br>剩余时间
								</span>
							</div>
						</div>
					</li>
					<li>
						...
						<div class="list-item">
							<a class="item-figure"
								href="/deal-show/id-2753" target="_blank">
								<img src="images/tt.jpg" alt="锦绣乡村 美丽中国">
							</a>
							<div class="item-upvote">
								<a class="icons " href="javascript:void(0);" rel="38"
									onclick="like_deal_v2(2753, this)">38</a>
							</div>
							<h3>
								<a href="/deal-show/id-2753"
									target="_blank">锦绣乡村 美丽中国</a>
							</h3>
							<div class="item-caption">
								<span class="caption-title">目标：<em>30天</em> <em><i
										class="font-yen">¥</i>30000</em></span> <span
									class="btn-base btn-red-h20 common-sprite"> <span
									class="common-sprite">众筹中</span>
								</span>
							</div>
							<div class="progress-bar">
								<span class="progress bg-red" style="width: 13%;"></span>
							</div>
							<div class="item-rate clearfix">
								<span class="rate1"> <em>13%</em><br>好评度
								</span> <span class="rate2"> <em><a>报名</a></em><br>
								</span> <span class="rate3"> <em>18天</em><br>剩余时间
								</span>
							</div>
						</div>
					</li>
