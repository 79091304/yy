						...
						<form wx-validator="" wx-validator-ajax="" action="project-save"
							...
							<div class="project-edit">
								<div class="form-item clearfix">
									<label>姓名：</label> <input name="cname" type="text" id="cname"
										class="inp-w310" wx-validator-rule="required|maxLength"
										wx-validator-param="|10" wx-validator-placeholder="名称不可超过10个字，填写真实姓名"
										wx-validator-name-maxlength="名称不可超过10个字,填写真实姓名" value=""
										maxlength="10" placeholder="名称不可超过10个字,填写真实姓名">
								</div>
								<div class="form-item clearfix">
									<label>年龄：</label> <input name="deal_days" id="cdays"
										type="text"
										onkeyup="return;this.value=this.value.replace(/[^\.\d]/g,'')"
										wx-validator-rule="required|digits|range"
										wx-validator-param="||20-90" wx-validator-placeholder="20~90"
										value="" placeholder="20~90"><span
										class="input-notes" style="margin-left: 5px"></span><span
										...
										id="wx-validator-deal_days-range" class="error-text hidden">20~90岁</span>
								</div>
								<div class="form-item clearfix">
									<label>类别：</label>
								...
								<div class="form-item clearfix">
									<label>相关视频：</label> <input type="text" name="vedio"
