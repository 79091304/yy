...
public class StringUtils extends org.apache.commons.lang.StringUtils{
    ...
    public static String trimSbc(String tarStr){
     ...
     public static String change(String htmlStr) {
        ...
        String temp = htmlStr;
        String regEx_a = "(<[\\s]*?(a|A)[^>]*?>[\\s\\S]*?<[\\s]*?\\/[\\s]*?(a|A)[\\s]*?>)";
...
//        String regEx_src="(src\\s*=\\s*(\"|'|)http://\\w+\\.360buy\\.com[\\s\\S]*?)";
        ...
        String regEx_href_content="(href=[\\\"\\'](http:\\/\\/|\\.\\/|\\/)?\\w+(\\.\\w+)*(\\/\\w+(\\.\\w+)?)*(\\/|\\?\\w*=\\w*(&\\w*=\\w*)*)?[\\\"\\'])";
        ...
        while (m_a.find()) {
            ...
            if (!m_href.find()) {
                ...
                while(m_content.find()){      //只替换href的内容
                    ...
                    temp = stringReplace(temp, change, "href=\"#\"");
                }
            }
        }
...
//        }
    ...
    public static void main(String args[]){
        String testStr="<div class=\"mc\">\n" +
                ...
                "\t\t\t\t\t<ul class=\"list-h\">\n" +
                "                        <li class=\"fore\">\n" +
                "<div class=\"p-img\"><a href=\"http://www.360buyimg.com/product/177130.html\" target=\"_blank\"><img height=\"100\" width=\"100\" alt=\"飞利浦（PHILIPS）X630 GSM手机(炫酷黑)\" src=\"http://img10.360buyimg.com/n4/3646/f1168036-8be9-4da7-9ba0-1815d987d316.jpg\"></a></div>\n" +
                "<div class=\"p-name\"><a href=\"http://www.360buy.com/product/177130.html\" target=\"_blank\">飞利浦（PHILIPS）X630 GSM手机(炫酷黑)<font color=\"#ff6600\">最长50天待机，超薄直板待机王！尾货包销，特价出击！</font></a></div>\n" +
